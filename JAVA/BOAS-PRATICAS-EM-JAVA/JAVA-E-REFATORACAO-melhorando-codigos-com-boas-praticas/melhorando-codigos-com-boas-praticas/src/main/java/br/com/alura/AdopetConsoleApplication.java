...
public class AdopetConsoleApplication {
    ...
    private static void cadastrarAbrigo() throws IOException, InterruptedException{
        ...
        HttpClient client = HttpClient.newHttpClient();
        String uri = "http://localhost:8080/abrigos";
        HttpResponse<String> response = DispararRequisisaoPost(client, uri, json);
    ...
    private static HttpResponse<String> DispararRequisisaoPost(HttpClient client, String uri, JsonObject json) throws IOException, InterruptedException{
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
