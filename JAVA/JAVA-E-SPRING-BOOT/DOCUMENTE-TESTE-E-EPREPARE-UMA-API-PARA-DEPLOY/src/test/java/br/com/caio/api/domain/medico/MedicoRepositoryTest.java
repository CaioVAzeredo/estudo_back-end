...
//        try {
//            medicoRepository.count(); // Testa se a tabela existe
//        } catch (Exception e) {
//            throw new IllegalStateException("Tabelas não foram criadas. Verifique a configuração do Flyway.", e);
//        }
//    }
...
//        var medico = cadastrarMedico("Medico Teste", "teste@teste.com", "123456", Especialidade.CARDIOLOGIA);
//
//        // when
...
//                .isNotNull()
//                .extracting(Medico::getId)
//                .isEqualTo(medico.getId());
//    }
//
